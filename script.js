...
async function ensureSupabaseInitialized() {
    ...
    try {
        ...
        supabase = window.supabase.createClient(
            ...
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRkeHBvc3R3Ym1wbnNpa2pmdHZ5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDM2NjE0NDEsImV4cCI6MjA1ODc4NTkzMH0.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRkeHBvc3R3Ym1wbnNpa2pmdHZ5I',
            {
                auth: {
